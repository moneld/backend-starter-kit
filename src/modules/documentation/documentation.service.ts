...
export class DocumentationService {
  ...
  getApiInfo() {
    ...
    return {
      ...
      version:
        packageInfo.version || this.configService.get('app.apiVersion', '1.0'),
  ...
  getApiVersions() {
    ...
    const deprecatedVersions = this.configService.get(
      'app.deprecatedVersions',
      [],
    );
    const supportedVersions = this.configService.get('app.supportedVersions', [
      currentVersion,
    ]);
